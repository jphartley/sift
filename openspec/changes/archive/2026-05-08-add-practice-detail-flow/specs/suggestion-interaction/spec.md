...
The system SHALL show a subtle, non-red safety note when the selected practice has non-empty avoid-when guidance or high intensity. The note SHALL be omitted for low and medium intensity practices with no avoid-when guidance.
