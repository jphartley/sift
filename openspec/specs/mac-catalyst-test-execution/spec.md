## Purpose
Define the capability for running the `siftTests` unit test suite natively on macOS via the Mac Catalyst destination, eliminating simulator overhead for fast local feedback.
